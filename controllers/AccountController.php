...
namespace copoka\profile\controllers;

use Yii;
use copoka\profile\ProfileModule;
use copoka\profile\models\Profile;
use copoka\profile\models\ProfileSearch;
use copoka\profile\models\LoginForm;
